/**
 * @fileoverview Performance Bar Component
 * @description Displays agent performance metrics as a horizontal bar
 */
 ...
 * PerfBar 组件
 * 
 * @description 显示性能指标的水平条形图
 */
const PerfBar: React.FC<PerfBarProps> = ({ 
  avgPerf, 
  peakPerf, 
  maxPerf = 100, 
  color = '#3b82f6' 
